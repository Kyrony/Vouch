...
| HUD icon pack (soft-go) | wired in `assets/horror/hud/` | Leonardo HUD v3: shared EMPTY neon-rim health/stamina/fear tracks + chips (eng fill %) / **phone LED** (not a torch) / signal full-weak-dead / E interact. Wiring ref — Leonardo redraw may replace textures before Steam. |
