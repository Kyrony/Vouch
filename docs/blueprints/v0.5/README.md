...
| HUD icon pack (soft-go) | wired in `assets/horror/hud/` + `hud/k7_overlays/` | **K7 diegetic phone**: PhoneRoot chrome, stats on the phone, right **5-slot item rail** wells **88×80**, phone-toast InteractPrompt. Eng fill %. No fear bar / chips / bottom hotbar. **Phone LED** (not a torch). |
